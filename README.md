...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zpzkk8q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zpzkk8q.containers.anotherwebservice.com/
...
```
git clone git@github.com:JerryGarcia1942/container-zpzkk8q.git
cd container-zpzkk8q
```
...
```
docker attach container-zpzkk8q
```
